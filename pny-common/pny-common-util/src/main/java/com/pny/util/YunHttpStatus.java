...
public enum YunHttpStatus {
    ...
    YunHttpStatus(int value, String reasonPhrase) {
        this.value = value;
     ...
     */
    public static YunHttpStatus valueOf(int statusCode) {
        for (YunHttpStatus status : values()) {
    ...
    public enum Series {
        ...
        public static Series valueOf(YunHttpStatus status) {
